...
ACTION_ROUTE_RULES: tuple[tuple[str, str, str], ...] = (
    ...
    ("POST", r"/projects/[^/]+/documents/[^/]+/targeting/recompute$", "file:bind"),
    ("POST", r"/projects/[^/]+/documents/[^/]+/versions$", "file:upload"),
    ("DELETE", r"/projects/[^/]+/documents/[^/]+$", "file:withdraw"),
    ("POST", r"/projects/[^/]+/material-targeting/recompute$", "file:bind"),
    ...
    ("PUT", r"/projects/[^/]+/ndt/documents/[^/]+/bindings$", "file:bind"),
    ("POST", r"/projects/[^/]+/ndt/material-submissions$", "ndt:submit"),
    ...
    ("POST", r"/review-runs/[^/]+/human-input-tasks/[^/]+/responses$", "review:save"),
    ...
    ("POST", r"/fde/review-runs/[^/]+/raw-vault/verify$", "fde:dashboard:view"),
    ("POST", r"/fde/document-ai/shadow-runs/[^/]+/pipeline-comparison$", "fde:ai-run:replay"),
    ...
    ("POST", r"/fde/vector-corrections/[^/]+/approve$", "fde:vector-quality:review"),
    ("POST", r"/fde/vector-corrections/[^/]+/reject$", "fde:vector-quality:review"),
    ("POST", r"/fde/vector-corrections/[^/]+/apply$", "fde:vector-quality:apply"),
    ...
    ("POST", r"/knowledge/reindex-preview$", "knowledge:manage"),
    ...
    ("POST", r"/rules/versions/[^/]+/[^/]+-preview$", "knowledge:manage"),
