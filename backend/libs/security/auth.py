...
USERS = {
    ...
    "fde": user_record("USER-FDE-001", "fde", "fde", "6", "FDE", "FDE 工程师", "AI 交付治理组", ["fde:dashboard:view", "fde:ai-run:view-masked", "fde:ai-run:replay", "fde:feedback:view", "fde:feedback:triage", "fde:evaluation:view", "fde:evaluation:manage", "fde:evaluation:run", "fde:business-pack:view", "fde:business-pack:validate", "fde:capability-bundle:manage", "fde:release:view", "fde:release:submit", "fde:release:shadow", "fde:release:canary", "fde:release:rollback", "fde:ocr-quality:view", "fde:incident:manage", "fde:config:draft"]),
