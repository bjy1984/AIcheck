...
MONGO_INDEXES = {
    ...
    "review_runs": [
        [("projectId", 1), ("nodeId", 1), ("status", 1), ("createdAt", -1)],
        [("reviewRunId", 1), ("status", 1)],
        [("workflowId", 1)],
        [("aiRunId", 1)],
    ],
    "review_step_runs": [[("reviewRunId", 1), ("sequence", 1)], [("status", 1), ("startedAt", -1)]],
    "review_graph_nodes": [[("reviewRunId", 1), ("sequence", 1)], [("reviewRunId", 1), ("status", 1)]],
    "review_tool_calls": [[("reviewRunId", 1), ("nodeKey", 1)], [("toolName", 1), ("createdAt", -1)]],
    "review_events": [[("reviewRunId", 1), ("createdAt", 1)], [("eventType", 1), ("status", 1)]],
    "retrieval_traces": [
        [("reviewRunId", 1), ("createdAt", -1)],
        [("queryType", 1), ("kbVersion", 1)],
        [("evaluationRunId", 1), ("evaluationCaseId", 1)],
        [("selectedRoute", 1), ("createdAt", -1)],
    ],
    "rule_check_results": [[("reviewRunId", 1), ("ruleCode", 1)], [("result", 1), ("createdAt", -1)]],
    ...
    "evaluation_cases": [
        [("evaluationSetId", 1), ("riskLevel", 1)],
        [("businessPackId", 1), ("nodeId", 1)],
        {"keys": [("sourceFeedbackId", 1)], "options": {"unique": True, "sparse": True}},
    ],
    "evaluation_case_results": [
        [("evaluationRunId", 1), ("status", 1)],
        [("evaluationCaseId", 1), ("evaluationRunId", 1)],
        [("sourceFeedbackId", 1), ("evaluationRunId", 1)],
    ],
    ...
    "ocr_annotation_tasks": [[("scenario", 1), ("collectionStatus", 1)], [("profileId", 1), ("updatedAt", -1)]],
    "ocr_annotation_imports": [[("status", 1), ("createdAt", -1)], [("source", 1), ("createdAt", -1)]],
    ...
    "cost_budget_change_requests": [[("budgetId", 1), ("status", 1), ("createdAt", -1)]],
    "data_exports": [[("requesterUserId", 1), ("status", 1), ("createdAt", -1)]],
    "masking_policies": [[("targetType", 1), ("fieldPath", 1), ("status", 1)]],
    ...
    "knowledge_clauses": [
        [("kbDocId", 1), ("clauseNo", 1), ("status", 1)],
        [("businessPackId", 1), ("nodeTypes", 1), ("status", 1)],
        [("businessPackId", 1), ("materialTypes", 1), ("status", 1)],
    ],
    "knowledge_page_index_nodes": [
        [("kbDocId", 1), ("kbVersion", 1), ("nodeId", 1)],
        [("parentNodeId", 1), ("status", 1)],
        [("businessPackId", 1), ("nodeTypes", 1), ("status", 1)],
        [("businessPackId", 1), ("materialTypes", 1), ("status", 1)],
    ],
