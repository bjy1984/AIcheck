...
R24_R34_BUSINESS_PROFILE_FIELDS = {
    ...
    "weld_repair_record_v1": ("weld_repair_record", ["record_no", "weld_no", "repair_application_no", "repair_procedure_no", "repair_procedure_approved", "same_location_repair_count", "original_inspection_method", "post_repair_ndt_report_no", "post_repair_ndt_method", "post_repair_ndt_result"], ["记录编号", "焊缝编号", "返修申请单号", "返修工艺编号", "返修工艺批准", "同一部位返修次数", "原检测方法", "返修后检测报告编号", "返修后检测方法", "返修后检测结论"]),
    ...
    "heat_treatment_record_v1": ("heat_treatment_record", ["record_no", "weld_no", "curve_ref", "curve_continuous", "heating_rate", "holding_temperature", "holding_minutes", "cooling_rate"], ["记录编号", "焊缝编号", "温度时间曲线", "曲线完整无中断", "升温速率", "保温温度", "保温时间", "降温速率"]),
