...
def evaluate_r39_procedure_reference(arguments):
    if "fieldPairs" in arguments:
        from libs.review_tools.r39_field_pairs import evaluate_field_pairs
        return evaluate_field_pairs(arguments, evaluate_r39_procedure_reference)
