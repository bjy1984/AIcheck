...
FILENAME_PROFILE_SIGNALS = (
    ...
    ("manufacturing_supervision_certificate_v1", ("制造监督检验证书", "制造监检证书", "监督检验证书")),
    ("type_test_report_v1", ("型式试验证书", "型式试验报告", "型式试验")),
    (
        "foreign_component_inspection_record_v1",
        ("到岸检验", "口岸检验", "使用地检验", "随整机检验", "整机安全性能检验"),
    ),
    ("factory_inspection_report_v1", ("出厂检验报告", "出厂质量检验报告", "出厂检验")),
    (
        "material_retest_report_v1",
        ("材料复验报告", "现场复验报告", "光谱分析报告", "硬度检测报告", "金相检验报告", "耐压试验报告"),
    ),
    ("sampling_witness_record_v1", ("抽样见证记录", "取样见证记录", "抽样复验见证")),
    ("acceptance_witness_record_v1", ("到货验收记录", "进场验收记录", "材料验收见证")),
    ("material_ndt_report_v1", ("材料无损检测报告", "母材无损检测报告", "原材料无损检测报告")),
    ("technical_review_approval_v1", ("技术评审证书", "技术评审批准", "技术评审意见")),
    ("new_material_data_v1", ("新材料性能数据", "材料性能数据")),
    ("material_mark_transfer_record_v1", ("材料标志移植", "材料标记移植", "标志移植记录")),
    ("material_substitution_approval_v1", ("材料代用", "材料替代", "材料代用批准")),
    ("valve_test_report_v1", ("阀门耐压试验", "阀门压力试验", "阀门施工记录")),
