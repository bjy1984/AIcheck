...
R36_TABLES = {"ndt_plan_context": "contexts", "ndt_plan_approval": "plans",
              "ndt_plan_items": "items", "ndt_design_requirements": "requirements", "ndt_standard_requirements": "standardRequirements"}
...
def build_r36_business_facts(state: dict[str, Any], run: dict[str, Any]) -> dict[str, Any]:
    ...
    facts: dict[str, Any] = {"projectId": run["projectId"], "requirements": groups["requirements"], "standardRequirements": groups["standardRequirements"]}
