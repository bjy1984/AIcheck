...
RESOURCE_STATE_CHANGED = BusinessErrorCode(40906, "RESOURCE_STATE_CHANGED", "数据状态已更新，请刷新后重试。")
...
SUBMISSION_WITHDRAW_NOT_ALLOWED = BusinessErrorCode(
    40922,
    "SUBMISSION_WITHDRAW_NOT_ALLOWED",
...
REVIEW_STATE_UNAVAILABLE = BusinessErrorCode(50334, "REVIEW_STATE_UNAVAILABLE", "暂时无法核对交接状态，请稍后重新核对。")
OFFICE_PREVIEW_UNAVAILABLE = BusinessErrorCode(50332, "OFFICE_PREVIEW_UNAVAILABLE", "Office 在线预览服务暂不可用。")
