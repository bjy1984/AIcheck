...
RULE_PROFILES: dict[str, tuple[list[str], str, str]] = {
    ...
    "R33": (["r33.instrumentRecords", "r33.temperaturePointLayouts", "r33.reviewDate"], "evaluate_heat_treatment_instruments", "r33_heat_treatment_instruments"),
...
PILOT_BINDINGS: dict[str, dict[str, Any]] = {
    ...
    "AC-R33-01": {"facts": ["r33.instrumentRecords", "r33.temperaturePointLayouts", "r33.reviewDate"], "tools": ["extract_document_fields", "evaluate_heat_treatment_instruments"], "parameters": {"argumentProfile": "r33_calibration_and_layout"}},
