...
class DeploymentConfigValidator:
    ...
    def check_runtime_assets(self) -> None:
        ...
        if len(items) != 164:
            failures.append(f"material review asset must contain 164 items, got {len(items)}")
        ...
        self.add(
            ...
            "fail" if failures else "pass",
            "; ".join(failures) if failures else "Versioned material review asset contains 164 items.",
