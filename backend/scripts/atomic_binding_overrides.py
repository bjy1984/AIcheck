...
ATOMIC_BINDING_OVERRIDES.update({
    "AC-R40-01": {"tools": ["get_document_ocr_result", "extract_document_fields", "extract_table_records", "check_required", "evaluate_ndt_process", "evaluate_r40_parameters", "validate_evidence_grounding"], "parameters": {"profile": "ndt_record_report", "clauseSource": "frozen_standard_clause_package",
