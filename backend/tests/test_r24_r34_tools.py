...
def test_r31_more_than_two_repairs_requires_special_technical_approval() -> None:
    base = {"weldNo": "W-1", "repairApplicationNo": "RA-1", "repairProcedureNo": "RP-1", "causeAnalysis": "夹渣", "sameLocationRepairCount": 3, "postRepairNdtReportNo": "RT-1", "postRepairNdtResult": "合格"}
...
def test_r33_instrument_calibration_and_point_layout() -> None:
    ...
    output = evaluate_heat_treatment_instruments({"instrumentRecords": records, "temperaturePointLayouts": [{"drawingNo": "TP-1"}], "reviewDate": "2026-07-17"})
    assert output["result"] == "passed"
...
def test_r34_hardness_is_material_and_design_conditioned_not_fixed_generic_200() -> None:
    ...
    report = {"weldNo": "W-1", "curveContinuous": True, "curveRef": "CURVE-1"}
