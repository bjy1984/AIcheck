...
@pytest.mark.parametrize("name", sorted(BUSINESS_TOOL_NAMES - ({
    ...
    "evaluate_r15_type_test_coverage",
    "evaluate_valve_test",
    "evaluate_r37_defect_closure",  # Dedicated inventory reconciliation tests.
    "evaluate_r37_progressive_inspection",  # Dedicated staged coverage tests.
    ...
    "evaluate_r53_equipment_connection",  # Dedicated frozen-rule cases in test_installation_domain_rules.py.
    "evaluate_r54_compensator",  # Dedicated frozen-rule cases in test_installation_domain_rules.py.
    "evaluate_r55_supports",  # Dedicated frozen-rule cases in test_installation_domain_rules.py.
