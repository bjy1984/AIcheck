...
def test_hyphen_and_en_dash_month_ranges_end_on_the_later_month() -> None:
    # 旧版首个日期把下一年份的前两位吞成「2024.11-20」：无表头时整行丢失，有表头时截止日错成 2024.11.20。
    assert _items(f"1 {C1} 2024.11-2028.10") == [("", "2028.10.31")]
    assert _items("序号 项目代号 有效期", f"1 {C1} 2024.11-2028.10") == [("", "2028.10.31")]
    assert _items("序号 项目代号 有效期", f"1 {C1} 2024.11–2028.10") == [("", "2028.10.31")]
    assert _items("序号 项目代号 有效期", f"1 {C1} 2024-11-2028-10") == [("", "2028.10.31")]
    assert _items("序号 项目代号 有效期", f"1 {C1} 2024.11.01-2028.10.31") == [("", "2028.10.31")]
    assert _items("序号 项目代号 批准日期 有效期", f"1 {C1} 2024.10.15 2024.11-2028.10") == [
        ("2024.10.15", "2028.10.31")]
    # 两个独立的连字符全日期不是区间，仍按表头列序。
    assert _items("序号 项目代号 批准日期 有效期", f"1 {C1} 2024-10-15 2028-10-14") == [
        ("2024.10.15", "2028.10.14")]
