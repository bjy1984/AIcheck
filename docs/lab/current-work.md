...
| 驗收工具 | 發布門檻、R35–37重放、三組品質統計 | 69×4及邊界、原36差異、真實樣本；PG/MinIO/Temporal本機實測已通過，最新一般回歸4835通過、0失敗、75跳過（已含最近 OCR／文件詳情及 R11 簽批／展示投影及壓力倍率缺失、精度、管線錯配、氣壓上限修復）；其中服務項已另以255條專項全部補驗，外部真人查詢未執行 | 待驗收 |
