...
- 目前無資料庫連線設定，`aicheck-prod-new` SSH 連線逾時，新七項目快照尚未生成。證據與操作見 `docs/lab/verification/2026-09-23-jev-ocr-only-export.md`。
...
- 真實題包仍須等七項目新快照；目前沒有監檢標註，故未產生準確率。見 `docs/lab/verification/2026-09-23-jev-blind-label-packet.md`。
...
- 新金鑰、七項目快照及監檢標註仍未到位，三組實際請求 0 次。詳細操作與邊界見 `docs/lab/verification/2026-09-23-jev-atomic-ocr-only-eval.md`。
