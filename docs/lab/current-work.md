...
| 標準 | 已入庫資料及部分查詢修復；壓力倍率缺失／非法值與未知方法猜值已修，pressureTest 凍結標籤已對原頁校正，倍率比較不再先四捨五入 | 26查詢／原因清單未結項，14976／13296／47014 C–F剩餘資料 | 待補齊 |
| 驗收工具 | 發布門檻、R35–37重放、三組品質統計 | 69×4及邊界、原36差異、真實樣本；PG/MinIO/Temporal本機實測已通過，最新一般回歸4796通過、0失敗、75跳過（已含最近 OCR／文件詳情及 R11 簽批／來源隔離／展示投影及壓力倍率缺失修復）；其中服務項已另以255條專項全部補驗，外部真人查詢未執行 | 待驗收 |
