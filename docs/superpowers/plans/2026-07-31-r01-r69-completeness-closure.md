...
- [ ] **Step 3: Implement one writable-font environment**
...
- [ ] **Step 1: Change count tests first**
...
- [ ] **Step 3: Add catalog rows and safe R69 validation**
...
- [ ] **Step 1: Write failing requirement-binding tests**
...
- [ ] **Step 3: Implement attachment mapping and page locators**
...
- [ ] **Step 4: Add source identities and truth domains**
...
- [ ] **Step 5: Correct the standards table**
...
- [ ] **Step 6: Regenerate JSON and verify GREEN**
...
- [ ] **Step 1: Write failing signature and image tests**
...
- [ ] **Step 3: Implement deterministic test seal graphics**
...
- [ ] **Step 4: Embed the contract in DOCX and XLSX**
...
- [ ] **Step 5: Implement three evidence-image layouts**
...
- [ ] **Step 1: Write failing content-chain tests**
...
- [ ] **Step 3: Author the four new control documents**
...
- [ ] **Step 4: Author the 14 image payloads**
...
- [ ] **Step 5: Populate dynamic SHA-256 rows during build**
...
- [ ] **Step 6: Regenerate content and verify GREEN**
...
- [ ] **Step 1: Update the expected metrics test first**
...
- [ ] **Step 3: Render every DOCX and inspect all pages**
...
- [ ] **Step 4: Inspect every XLSX sheet preview**
...
- [ ] **Step 5: Inspect every PDF page and JPG**
...
- [ ] **Step 6: Re-run fresh verification after any visual fix**
...
- [ ] **Step 7: Commit final generated pack**
...
- [ ] **Step 3: Push and inspect PR status**
