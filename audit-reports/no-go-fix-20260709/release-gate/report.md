...
- Generated at: 2026-07-10 09:32:12
...
| auth-contract | auth.security-contract | PASS | checks=14, failures=0 |
...
| api-contract | api.mutation-idempotency | PASS | mutatingRoutes=336, missing=0, direct=302, delegated=16, exempt=18 |
| api-contract | api.action-coverage | PASS | mutatingRoutes=336, covered=328, missing=0, exempt=8 |
| frontend-contract | frontend.contract | PASS | frontend=231, backend=657, missing=0 |
...
| release-gate | release.required-probes | FAIL | required=11, missing=8 |
| release-gate | release.security-scans | FAIL | Pass --security-scan-dir with current SBOM and vulnerability scan evidence. |
| live-deployment | live.probes | SKIP | Pass --include-live to run target API/OCR/LiteLLM probes. |

Summary: total=39, pass=36, warn=0, fail=2, skip=1.
