    ...
    <div class="aicheck-page app-shell">
      ...
      <div v-else-if="canShowWorkspace" class="workspace">
        ...
        <main class="center">
          ...
          <section v-if="role === 'inspection'" class="card">
            <div class="card-head">
              <h2>一、业务核验链路</h2>
          ...
          <section class="card node-package-card">
            <div class="card-head">
              <h2>
                {{
                  role === 'inspection'
          ...
          <section v-if="role === 'inspection'" class="result-band">
...
.aicheck-static-viewport {
  ...
  --red: #ff4d3d;
  --red-soft: #fff0ee;
  --shadow: 0 1px 2px rgba(20, 34, 56, 0.04);
  width: 100%;
  max-width: 100vw;
  height: 100vh;
  overflow: hidden;
...
.tree-wrap :deep(.node-button:focus-visible) {
  ...
  background: #f4f8ff;
  outline: 0;
  box-shadow: 0 0 0 3px rgba(31, 102, 216, 0.14);
}
