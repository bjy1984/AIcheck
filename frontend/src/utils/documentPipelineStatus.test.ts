...
const cases = [
  ...
  [{ currentOcrStatus: '已识别', sliceStatus: '已切片', vectorStatus: '待向量化' }, '待向量化'],
  [{ currentOcrStatus: '已识别', sliceStatus: '已切片', vectorStatus: '向量化中' }, '向量化中'],
  [{ currentOcrStatus: '已识别', sliceStatus: '已切片', vectorStatus: '已向量化' }, '已完成'],
  [{ currentOcrStatus: '已识别', sliceStatus: '切片失败' }, '失败可重试'],
  [{ currentOcrStatus: '已识别', sliceStatus: '已切片', vectorStatus: '向量化失败' }, '失败可重试']
] as const
